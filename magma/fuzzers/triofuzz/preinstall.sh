...
# Install LLVM/Clang with C++17 filesystem support
# Clang 11+ is required for trace-pc-guard coverage instrumentation
apt-get update && \
...
echo "[TrioFuzz] Installed Clang ${CLANG_VERSION} for C++17 filesystem support"

# Install TrioFuzz dependencies
