...
"""Integration code for TrioFuzz ablation: EcoFuzz-only (among Trio modules).

This variant keeps EcoFuzz power schedule enabled while disabling:
- Layer 2: MOpt PSO
- Layer 3: MuoFuzz Markov
"""
